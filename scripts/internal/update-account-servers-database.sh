...
load_dotenv .env
dotenv_files=("friends" "miiverse-api" "wiiu-chat" "super-mario-maker" "splatoon" "minecraft-wiiu" "pikmin-3" "pokken-tournament")
...
run_verbose docker compose exec -e SERVER_IP="$SERVER_IP" \
    ...
    -e POKKENTOURNAMENT_PORT="$PN_POKKENTOURNAMENT_AUTHENTICATION_SERVER_PORT" \
