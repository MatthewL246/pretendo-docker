...
# Generate a Kerberos password for the Minecraft: Wii U Edition server
splat_kerberos_password=$(generate_password 32)
echo "PN_MINECRAFT_KERBEROS_PASSWORD=$splat_kerberos_password" >>./minecraft.local.env
...
echo "PN_MINECRAFT_SECURE_SERVER_HOST=$server_ip" >>./splatoon.local.env
